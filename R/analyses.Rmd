...
dat1 <- data.frame(x = 1250, xmin = 460, xmax = 1900, y = 5.5, 
...
```{r pergene_lm}
x <- total_annot[total_annot$Distribution == "PerGene", ]
x <- x[x$Codons == "Var", ]
qplot(x$Observed, x$Distance, geom=c("point", "smooth"), method=lm, formula=y~x)
lm.pergene.var <- lm(x$Distance ~ x$Observed)
